    ...
    <div class="wrap">
        ...
        <h2 class="nav-tab-wrapper">
            <a href="?page=ppf_menu&tab=footer_management"
               class="nav-tab <?php echo $active_tab == 'footer_management' ? 'nav-tab-active' : ''; ?>">Footer Management</a>
            <a href="?page=ppf_menu&tab=header_management"
               class="nav-tab <?php echo $active_tab == 'header_management' ? 'nav-tab-active' : ''; ?>">Header Management</a>
            ...
            if ($email === 'edward@technicks.com'):?>
                <a href="?page=ppf_menu&tab=pawprint_restricted_settings"
                   class="nav-tab <?php echo $active_tab == 'pawprint_restricted_settings' ? 'nav-tab-active' : ''; ?>">Pawprint Restricted Settings</a>
            <?php endif; ?>
        </h2>
        ...
        <table class="form-table">
            <tr>
                <th><label for="trust-col-1">Column Left Content:</label></th>
                <td>
                    <?php wp_editor( '' , 'trust-col-1-editor', $settings = array('textarea_name'=>'trust-col-1') ); ?>
                </td>
            </tr>
            <tr>
                <th><label for="trust-col-2">Column Right Content:</label></th>
                <td>
                    <?php wp_editor( '' , 'trust-col-2-editor', $settings = array('textarea_name'=>'trust-col-2') ); ?>
                </td>
            </tr>
        </table>
            <?php submit_button(); ?>
