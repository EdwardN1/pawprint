...
function ppf_scripts() {
    ...
    wp_enqueue_style('ppf_billy_font',get_template_directory_uri().'/assets/fonts/billy/stylesheet.css','ppf-style');
    wp_enqueue_style('ppf_google_fonts','https://fonts.googleapis.com/css?family=Tajawal:200,300,400,500,700,800,900&display=swap','ppf_billy_font');
    wp_enqueue_style( 'ppf-style-css', get_template_directory_uri().'/assets/css/ppf.css', 'ppf_google_fonts', filemtime(get_template_directory().'/assets/css/ppf.css'), 'all' );
    //wp_enqueue_style( 'foundation-style-css', get_template_directory_uri().'/assets/styles/style.css', 'ppf-style-css', filemtime(get_template_directory().'/assets/styles/style.css'), 'all' );
    wp_enqueue_style( 'jamie-style-css', get_template_directory_uri().'/assets/css/jamie.css', 'ppf-style-css', filemtime(get_template_directory().'/assets/css/jamie.css'), 'all' );
